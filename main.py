...
# Screen constants for initialize
# It's better have any constant or configured var in the start point of the file
width, heigth = 800, 600  # Screen dimensions
bg = 25, 25, 25  # BG Colour
Ncs_x = 40  # Number of X cells
Ncs_y = 30  # Number of Y cell
title = "Game of Life"

# Initialize pygame screen with constants
pygame.init()
...
# Cells state. lives = 1; dead = 0;
# create a matrix with the size of the grid
gameState = np.zeros((Ncs_x, Ncs_y))  # Initial state of the grid -> all cells deads
